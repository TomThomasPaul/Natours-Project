...
if(alert === 'booking'){
  ...
  res.locals.alert = "Your booking was successful. Please check your email for confirmation. If your booking doesnt show up here immediately, please come back later,";
}
next();
}
